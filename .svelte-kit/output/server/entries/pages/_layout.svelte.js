import { D as DEV, S as BROWSER, T as sanitize_slots, V as rest_props, P as push, W as fallback, X as spread_attributes, Y as slot, Z as bind_props, R as pop, _ as sanitize_props, $ as element, a0 as attr, a1 as stringify, a2 as spread_props, a3 as copy_payload, a4 as assign_payload, Q as setContext, a5 as getContext, a6 as store_get, a7 as unsubscribe_stores, a8 as escape_html } from "../../chunks/index.js";
import { w as writable, d as derived } from "../../chunks/index3.js";
import { g as goto } from "../../chunks/client.js";
import { p as page } from "../../chunks/stores.js";
import { twMerge, twJoin } from "tailwind-merge";
import { F as Frame, W as Wrapper, T as ToolbarButton, B as Button, I as Input } from "../../chunks/Input.js";
...
function _layout($$payload, $$props) {
  ...
  if (loading) {
    ...
    if (user) {
      ...
      Navbar($$payload, {
        class: "fixed w-full z-20 bg-opacity-90 bg-black backdrop-blur-lg shadow-lg",
        children: ($$payload2) => {
          NavBrand($$payload2, {
            href: "/",
            class: "flex items-center",
            children: ($$payload3) => {
              $$payload3.out += `<img src="/cflogo.png" class="mr-3 h-8 sm:h-10" alt="CF Logo"> <span class="self-center text-2xl font-bold text-white">CF Cosmos</span>`;
            },
            $$slots: { default: true }
          });
          $$payload2.out += `<!----> `;
          NavUl($$payload2, {
            class: "flex-1 flex justify-center items-center mx-4 hidden md:flex",
            children: ($$payload3) => {
              NavLi($$payload3, {
                href: "/",
              ...
              NavLi($$payload3, {
                href: "/docs",
                active: store_get($$store_subs ??= {}, "$page", page).url.pathname.startsWith("/docs"),
                children: ($$payload4) => {
                  $$payload4.out += `<!---->Docs`;
                },
                $$slots: { default: true }
      ...
      $$payload.out += `<!----> <main class="pt-24 px-4 sm:px-6 lg:px-8"><!---->`;
      slot($$payload, $$props, "default", {}, null);
      $$payload.out += `<!----></main></div>`;
    } else {
      $$payload.out += "<!--[!-->";
      $$payload.out += `<h1 class="text-white text-5xl text-center">AUTH ERROR</h1>`;
    }
    $$payload.out += `<!--]-->`;
  }
  $$payload.out += `<!--]-->`;
